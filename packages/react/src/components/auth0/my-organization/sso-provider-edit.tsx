...
export function SsoProviderEdit(props: SsoProviderEditProps): React.JSX.Element {
  ...
  return (
    <GateKeeper
      ...
      onRetry={retry}
      isLoading={
        hookResult.isLoading || hookResult.isLoadingConfig || hookResult.isLoadingIdpConfig
      }
    >
      <SsoProviderEditView
        {...hookResult}
...
/**
 * SSO provider edit view component.
 * @param props - {@link SsoProviderEditViewProps}
 * @returns JSX element
 */
export function SsoProviderEditView({
  styling,
  schema,
  readOnly,
  providerId,
...
}: SsoProviderEditViewProps): React.JSX.Element {
